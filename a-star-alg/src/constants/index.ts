...
export const vertices: Vertex[] = [
	startVertex,
	{ id: "AzadeganSquare", x: 100, y: -200, h: 0.7 },
	{ id: "Mahidasht", x: 900, y: -200, h: 1.2 },
	{ id: "SarabGhanbar", x: 400, y: -100, h: 3.2 },
	{ id: "Delgosha", x: 100, y: 100, h: 14.6 },
	{ id: "AshrafiEsfahani", x: -100, y: 100, h: 18.2 },
	{ id: "Beltway", x: -200, y: -300, h: 16 },
	{ id: "Halashi", x: 1200, y: 400, h: 2.3 },
	{ id: "Pirozi", x: 200, y: 100, h: 0.2 },
	{ id: "ImamKhomaini", x: -600, y: 600, h: 0.5 },
	{ id: "SayadShirazi", x: -1000, y: 400, h: 2.6 },
	{ id: "ZakariayRazi", x: -1000, y: -300, h: 9.3 },
	{ id: "Rodaki", x: -900, y: 0, h: 1.2 },
	{ id: "Kashani", x: -200, y: 0, h: 0.3 },
	{ id: "Rajaee", x: -100, y: -100, h: 2.3 },
	{ id: "Jalalieh", x: -100, y: -200, h: 2.6 },
	goalVertex,
];
